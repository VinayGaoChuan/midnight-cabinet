...
(function () {
  window.__prog = async function (secs, o = {}) {
    ...
    const oBegin = P.beginBattle, oWin = P.runWin, oFail = P.runFail, oRE = P.raidEnd, oPass = P.passDay, oSettle = P.startSettle, oSR = P.startRaid;
    ...
    finally { P.beginBattle = oBegin; P.runWin = oWin; P.runFail = oFail; /* oF2 wraps the recorder's runFail and goes with it */ P.raidEnd = oRE; P.startSettle = oSettle; P.startRaid = oSR; if (oPass) P.passDay = oPass; }
  };
})();
