...
const SHOPS = {
  ...
  refugee:  { n: '难民营', d: '全是普通部队，价格减半。', units: 8, pool: (k) => DB[k].q === 0, price: 0.5, w: 2, unit: 1 },
  ...
  veterans: { n: '老兵之家', d: '只卖你部队里最多的两个职业的战旗，半价。', banners: 2, vocBanners: 1, price: 0.5, w: 1 },
  quarter:  { n: '军需官', d: '三面战旗免费，只能拿走一面。', banners: 3, price: 0, pickOne: 1, w: 1 },
  grocer:   { n: '杂货铺', d: '四个支援道具，一个价。', items: 4, w: 2 },
  alchemy:  { n: '炼金坊', d: '支援道具五折，但只有两个。', items: 2, price: 0.5, w: 1 },
  gamble:   { n: '赌坊', d: '支援道具半价，买一个有 30% 概率多送一个。', items: 3, price: 0.5, bonus: 0.3, w: 1 },
