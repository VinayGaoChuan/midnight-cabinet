...
const ITEMS = {
  ...
  heal:{ name:'回魂烛', icon:'candle', desc:'治疗全队。高品质加护盾、复活', tiers:['回复 20%','回复 50%','回满 + 护盾','回满 + 护盾 + 复活 1 名'] },
  frame:{ name:'旧相框', icon:'frame', desc:'从相框里召唤帮手', tiers:['1 只火小鬼','3 只火小鬼','1 只巨型怨灵','2 只怨灵 + 3 只小鬼'] },
  bell:{ name:'招魂铃', icon:'bell', desc:'震慑敌人，传说让它们自相残杀', tiers:['敌人停顿 1 秒','停顿 2 秒','停顿 3.5 秒','敌人互相攻击 5 秒'] },
  cup:{ name:'骰盅', icon:'die', desc:'直接加倍率，全看运气', tiers:['倍率 +0.2','倍率 +0.5','倍率 +1','倍率 +2.5'] },
};
const WHEEL = [
