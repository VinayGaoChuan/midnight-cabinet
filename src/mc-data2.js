...
const TALENTS = {
  atk: [
    ...
    { n:'迅捷咏唱', d:'技能冷却 -20%', m:{ skillCd:-0.2 } }, { n:'怒气', d:'领袖上场后 6 秒攻击翻倍', m:{ rage:1 } }, { n:'火种', d:'【火】部队伤害 +25%', m:{ fire:0.25 } },
    { n:'兽群', d:'【兽】部队攻速 +20%', m:{ beastAs:0.2 } }, { n:'处刑', d:'击杀精英时领袖回复 5% 生命', m:{ eliteHeal:0.05 } } ],
  def: [
    { n:'厚皮', d:'领袖生命 +25%', m:{ heroHp:0.25 } }, { n:'坚阵', d:'部队生命 +12%', m:{ unitHp:0.12 } }, { n:'喘息', d:'每场战斗后回复 6% 生命', m:{ postHeal:0.06 } },
    { n:'赖账', d:'积分不足时受到的伤害 -35%', m:{ shortRed:0.35 } }, { n:'保险柜', d:'死亡不掉落的宝物格 +1', m:{ bank:1 } }, { n:'好体质', d:'医院疗养速度 +50%', m:{ hospital:0.5 } },
