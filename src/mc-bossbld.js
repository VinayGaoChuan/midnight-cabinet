...
const LIST = {
  ...
  bb_queen: BB('FB_queen', '精灵女王雕像', 'faith', 'nature', 'bronze', 400, 4, { faithDaily: 4, feverRate: 0.12 }, '每天产出 4 信仰值；FEVER 槽涨得快 12%。'),
  bb_doll: BB('FB_doll', '旋转木马', 'store', 'cartoon', 'bronze', 360, 4, { startItem: 1, startItemQ: 1 }, '出征开局多带 2 个支援道具，其中一个第一次用至少转出「史诗」效果。'),
  bb_clown: BB('FB_clown', '马戏大棚', 'store', 'cartoon', 'stone', 380, 4, { feverStart: 0.25 }, '每场战斗开局，FEVER 槽已经有 25%。'),
