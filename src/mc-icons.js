...
const CAT_D = { core: '所有物资、图纸和宝物都放在这里。', power: '每天产出物资、碎片或经验球。', forge: '用宝物图纸打造宝物。', med: '让受伤的领袖回血。', recruit: '招募新的领袖。', train: '把经验球灌给领袖。', store: '每天产出物资，或提供出征补给。', defense: '混沌来袭时向地面开火。', luck: '出征时带来好运。', misc: '各种特殊效果。' };
