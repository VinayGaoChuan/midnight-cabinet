...
Object.assign(G, {
  ...
  relicBpTip(key, owned) { const R = M.RELICS[key]; return { title: R.n, c: owned ? '#ffe8b0' : '#8d8496', kind: owned ? '拥有图纸 × ' + owned + ' · 打造花费 ' + this.craftCost() + ' 物资' : '没有图纸', d: R.d + ' 品质越高，能力条目越多：打造出白银品质，就同时拥有黑铁 + 青铜 + 白银三条能力。', lines: R.lines.map((l, i) => ({ t: M.QUALITY[i].n + '：' + M.statText(l.k, l.v), c: M.QUALITY[i].c })) }; },
