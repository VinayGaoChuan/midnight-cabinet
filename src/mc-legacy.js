...
const KITS = M.KITS2 = [
  ...
  { k: 'focus', n: '专精', ic: 'e_card', d: '部队池少 2 种，更容易进化。', cost: 300 },
...
const ACH = M.ACH2 = [
  ...
  { k: 'evo3', n: '三次进化', d: '让一支部队进化 3 次', tok: 100, ok: (m, p) => (p.stats.evoMax || 0) >= 3 },
  { k: 'evo5', n: '完全进化', d: '让一支部队进化 5 次', tok: 200, ok: (m, p) => (p.stats.evoMax || 0) >= 5 },
