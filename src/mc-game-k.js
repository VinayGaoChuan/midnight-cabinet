...
const TAL_IC = { heroAtk: 't_sword', unitAtk: 't_command', crit: 't_crit', skillCd: 't_hourglass', rage: 't_rage', rngAtk: 'v_archer', warAs: 'v_warrior', magMana: 'v_mage', vanHp: 'v_vanguard', priHp: 'v_priest', eliteHeal: 't_heal',
