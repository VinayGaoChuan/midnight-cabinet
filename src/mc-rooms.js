...
// what each scene shows, in words (docs/effects.md §R is generated from this; keep it in step with the painters above)
M.ROOM_D = {
  core: '货架堆满物资箱，右侧电梯井通往地面，搬运工来回走',
  generator: '两个大齿轮夹着锅炉转动，工人值守',
  smithy: '炉火熊熊的锻炉和铁砧，铁匠抡锤',
  hospital: '两张病床、红十字灯箱、心电监护屏跳动',
  altar: '紫色法阵上光柱从天而降，施法者召魂',
  training: '木桩假人和杠铃，士兵在训练',
  storage: '堆叠的木箱和一只粉色气球',
  farm: '三层种植架，粉紫色补光灯，植物随风摆动',
  pool: '蓝色净水池、水泵，气泡往上冒',
  ...
  tesla: '线圈顶端电球放电，电弧四射',
  spire: '悬浮的紫水晶和旋转符环',
  wolfsburg: '机械臂在流水线上组装小车',
  venice: '水道船坞，帆船和吊臂',
  ruhr: '矿井井架、矿车和发光熔炉',
  eiffel: '月夜下的铁塔，灯光闪烁',
  machu: '夕阳下的梯田石城和瀑布',
  pyramids: '金色沙漠里的大金字塔和方尖碑',
  stonehenge: '月夜巨石阵，中央石门发光',
  gardens: '层层垂藤的阶梯花园、棕榈和夕阳',
  artemis: '月夜里的白色希腊神庙列柱，祭坛火',
  library: '满墙书架，发光的卷轴格和飘浮光点',
  colossus: '海港上跨立的铜色巨像高举火炬',
  terracotta: '成排的陶俑士兵，烛光摇曳',
  zeus: '黄金宝座上的宙斯手握闪电',
  kotoku: '青铜大佛、松树和香炉青烟',
  hagia: '暮色里的大圆顶和宣礼塔',
  forbidden: '红墙金瓦的宫殿，红灯笼，月夜',
  taj: '月夜里的白色陵墓和倒影水池',
  bigben: '表盘发光的钟楼，月夜街景',
  liberty: '海上的女神像高举火炬',
  opera: '海边白色贝壳屋顶，音符飘起',
  goldengate: '雾中的红色悬索桥和海面',
  amundsen: '极光下雪地里的冰屋和科考站',
  potala: '雪山上的白红宫殿，经幡飘动',
  michel: '月夜海中孤岛上的修道院尖塔',
  lighthouse: '夜海上塔顶灯火扫射',
  angkor: '夕阳下的石塔寺庙和莲池',
  maracana: '灯光球场，满座看台，球员对抗',
  tavern: '吧台、酒瓶墙、啤酒杯、酒桶和灯笼',
  meditation: '（待做）暂用训练场的木桩和杠铃，紫色墙面',
  armory: '（待做）暂用训练场的木桩和杠铃',
  shaolin: '（待做）暂用训练场的木桩和杠铃，红色墙面',
  colosseum: '（待做）暂用训练场的木桩和杠铃',
};
})();
